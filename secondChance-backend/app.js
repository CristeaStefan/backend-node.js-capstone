...
// Use Routes
app.use('/api/secondchance/items', secondChanceItemsRoutes); // Task 2: Add secondChanceItemsRoutes to the server
app.use('/api/search', searchRoutes); // Task 2: Add searchRoutes to the server
